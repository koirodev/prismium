import { PrismiumEventCallback, PrismiumEventListeners, PrismiumModule } from './index';
...
declare class Prismium {
   ...
   */
  constructor(el?: HTMLElement | string | PrismiumOptions, options?: PrismiumOptions);
